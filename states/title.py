...
class Title(State):
    ...
    def __init__(self):
        super().__init__()
        self.name = "title"
        self.clicker_btn = Button(x=self.canvas_width * 0.35, y=self.canvas_width//2, width=200, height=100, text="Clicker", text_color=(0, 0, 255))
        # self.clicker_btn = Button(self, x=self.canvas_width * 0.35, y=self.canvas_width//2, width=200, height=100, text="Clicker", text_color=(0, 0, 255))
    ...
    def render(self):
        ...
        btn_surface = self.clicker_btn.render()
        self.canvas.blit(btn_surface, (0, 0))
