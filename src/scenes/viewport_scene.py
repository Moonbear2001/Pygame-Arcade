...
class ViewportScene(Scene):
    def __init__(
        ...
        **kwargs
        ...
        #print("scene canvas size: ", self.canvas.get_size())
        #print("scene rect: ", self.rect)

    def _on_update(self, delta_time):
        """
        Updates the viewport position based on the target's position.
        """
        #print("on update in viewport scene")
    ...
    def render(self) -> pygame.Surface:
        ...
        if self.active:
            #print("render in viewport scene")
            self._on_render()
        ...
        # if self.active:
        #     # Render entire scene to the canvas
        #     super().render()
